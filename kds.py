...
with tab_maliyet:
    ...
    # ✅ MEVCUT DURUMU GRAFIK TABAN ÇIZGISI OLARAK EKLE
    ax_be.plot(df_md["ay"], [0] * len(df_md), color="gray", linewidth=2.5, 
               label="Mevcut Durum (Dizel Araç - Sıfır Referans)", linestyle="--", alpha=0.7)
